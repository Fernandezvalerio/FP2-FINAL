...
public class PreguntaGastronomia extends JPanel {
    ...
    public PreguntaGastronomia(String nombreUsuario, Inicio inicio) {
    ...
    private void cargarPreguntasDesdeBD() {
        ...
        try (Connection conn = Conexion.getConnection()) {
            String query = "SELECT * FROM preguntas_gastronomia";
